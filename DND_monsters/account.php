...
function herhaal_wachtwoord_control($wachtwoord,$herhaal_wachtwoord){
...
function Registreren($postEmail,$postNaam,$postWachtwoord){
...
function login($postEmail,$postWachtwoord){
    global $serverConnectieData;
    try
        {
            // Maak een nieuwe connectie naar de database "dnd_npc"
